...
namespace Prova2_APS.Controllers
{
    public class TipoPagamentoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TipoPagamentoId,NomeDoCobrado,InformacoesAdicionais")] TipoPagamento tipoPagamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TipoPagamentoId,NomeDoCobrado,InformacoesAdicionais")] TipoPagamento tipoPagamento)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!TipoPagamentoExists(tipoPagamento.TipoPagamentoId))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.TiposPagamento.Any(e => e.TipoPagamentoId == id);
        }
    }
}
