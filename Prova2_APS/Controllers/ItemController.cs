...
namespace Prova2_APS.Controllers
{
    public class ItemController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ItemId,Preco,Percentual,Quantidade")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ItemId,Preco,Percentual,Quantidade")] Item item)
        {
            if (id != item.ItemId)
            {
                return NotFound();
